...
Account.create(user_id: 1, name: "Preston Checking", bank: "WF", account_number: 543832, balance: 54390.09)
Account.create(user_id: 1, name: "Preston Savings", bank: "WF", account_number: 7482935, balance: 45060.54)
Account.create(user_id: 2, name: "Echo Checking", bank: "Citi Bank", account_number: 9764354, balance: 55456.24)
Account.create(user_id: 2, name: "Echo Savings", bank: "Citi Bank", account_number: 7352643, balance: 40930.49)
Account.create(user_id: 1, name: "China Checking", bank: "Bank of China", account_number: 6473839, balance: 16043.43)
Account.create(user_id: 1, name: "China Savings", bank: "Bank of China", account_number: 3285640, balance: 12053.13)
